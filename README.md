...
Once the `conda-forge` channel has been enabled, `gevent-websocket` can be installed with:

```
conda install gevent-websocket
```

It is possible to list all of the versions of `gevent-websocket` available on your platform with:
